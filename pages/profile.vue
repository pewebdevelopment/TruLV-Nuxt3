        ...
        <div class="container mx-auto sm:px-4">
            <div class="page-header-content">
                <div class="page-header-inner">
                    ...
                    <ol class="page-title">
                        <li><NuxtLink to="/" class="font-bold">Home - <span class="font-normal">William Smith</span></NuxtLink></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="section-wrapper">
                <div class="member-profile">
                        ...
                        <div class="profile-information">
                            <div class="profile-pic">
                                ...
                                <div class="custom-upload">
                                    <div class="file-btn">
                                        <span class="hidden lg:inline-block"> <i class="icofont-camera"></i>
                                            Edit</span>
                                        <span class="lg:hidden mr-0"><i class="icofont-plus"></i></span></div>
                                    <input type="file">
                                </div>
                            </div>
                    ...
                    <div class="profile-item hidden">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                              <NuxtLink to=""><img src="../assets/images/profile/Profile.jpg" alt="profile"></NuxtLink>
                            </div>
                    ...
                    <div class="profile-details">
                        <nav class="profile-nav">
                            <div class="flex flex-wrap list pl-0 mb-0 border border-t-0 border-r-0 border-l-0 border-b-1 border-gray-200" id="nav-tab" role="tablist">
                                <button class="inline-block py-2 px-4 no-underline active" id="nav-ativity-tab" data-bs-toggle="tab"
                                    href="#activity" type="button" role="tab" aria-controls="activity"
                                    aria-selected="true">Activity</button>
                                <button class="inline-block py-2 px-4 no-underline" id="nav-profile-tab" data-bs-toggle="tab"
                                    href="#profile" type="button" role="tab" aria-controls="profile"
                                    aria-selected="false">Profile</button>
                                <button class="inline-block py-2 px-4 no-underline" id="nav-friends-tab" data-bs-toggle="tab"
                                    href="#friends" type="button" role="tab" aria-controls="friends"
                                    aria-selected="false">Friends <span class="item-number">16</span></button>
                                <button class="inline-block py-2 px-4 no-underline" id="nav-groups-tab" data-bs-toggle="tab"
                                    href="#groups" type="button" role="tab" aria-controls="groups"
                                    aria-selected="false">Groups <span class="item-number">06</span></button>
                                <button class="inline-block py-2 px-4 no-underline" id="nav-photos-tab" data-bs-toggle="tab"
                                    href="#photos" type="button" role="tab" aria-controls="photos"
                                    aria-selected="false">Photos</button>
                                <button class="inline-block py-2 px-4 no-underline" id="nav-media-tab" data-bs-toggle="tab" href="#media"
                                    type="button" role="tab" aria-controls="media" aria-selected="false">Media <span
                                        class="item-number">35</span></button>
                                <div class="relative">
                                  <NuxtLink to="" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline  inline-block w-0 h-0 ml-1 align border-b-0 border-t-1 border-r-1 border-l-1" role="button" id="dropdownMenuLink"
                                        data-bs-toggle="dropdown" aria-expanded="false">

                                  </NuxtLink>
                                    

                                    <ul class=" absolute left-0 z-50 float-left hidden list-reset	 py-2 mt-1 text-base bg-white border border-gray-300 rounded" aria-labelledby="dropdownMenuLink">
                                        <li><NuxtLink to='' class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0">Activity</NuxtLink></li>
                                        <li><NuxtLink to='' class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0">Privacy</NuxtLink></li>
                                        <li><NuxtLink to='' class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0">Block user</NuxtLink></li>
                                    </ul>
                                </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <!-- Activity tab -->
                            <div class="tab-pane activity-page opacity-0 opacity-100 block active" id="activity" role="tabpanel">
                                <div>
                                    <div class="flex flex-wrap ">
                                        <div class="xl:w-2/3 pr-4 pl-4">
                                            <article>
                                                <div class="activity-tab">
                                                    <ul class="flex flex-wrap list-none pl-0 mb-0  mb-3" id="pills-tab" role="tablist">
                                                        <li class="flex flex-wrap list-none pl-0 mb-0  mb-3" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="pills-personal-tab"
                                                        ...
                                                        <li class="flex flex-wrap list-none pl-0 mb-0  mb-3" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline active" id="pills-mentions-tab"
                                                        ...
                                                        <li class="flex flex-wrap list-none pl-0 mb-0  mb-3" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="pills-favorites-tab"
                                                        ...
                                                        <li class="flex flex-wrap list-none pl-0 mb-0  mb-3" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="pills-friends-tab"
                                                        ...
                                                        <li class="flex flex-wrap list-none pl-0 mb-0  mb-3" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="pills-groups-tab"
                                                    ...
                                                    <div class="tab-content activity-content" id="pills-tabContent">
                                                        <div class="tab-pane opacity-0" id="pills-personal" role="tabpanel"
                                                            ...
                                                            <div class="post-item mb-20">
                                                                    ...
                                                                    <div class="post-author">
                                                                        <div class="post-author-inner">
                                                                            ...
                                                                            <div class="author-details">
                                                                                <h6><NuxtLink to=''>William Smith</NuxtLink></h6>
                                                                ...
                                                                <div class="post-meta">
                                                                    <div class="post-meta-top">
                                                                        <p><NuxtLink to=''><i class="icofont-like"></i> <i
                                                                                    class="icofont-heart"></i> <i
                                                                                    class="icofont-laughing"></i>
                                                                                <span>Julia,
                                                                                    Petrova and 306 like this</span></NuxtLink>
                                                                        </p>
                                                                        <p>
                                                                          <NuxtLink to=''>136 Comments</NuxtLink>
                                                                        </p>
                                                                    </div>
                                                                    <div class="post-meta-bottom">
                                                                        <ul class="react-list">
                                                                            <li class="react"><NuxtLink to=''><i
                                                                                        class="icofont-like"></i>
                                                                                    Like</NuxtLink> </li>
                                                                            <li class="react"><NuxtLink to=''>
                                                                                    <i
                                                            ...
                                                            <div class="load-btn">
                                                                <NuxtLink to="" class="lab-btn">Load More Post <i
                                                                        class="icofont-spinner"></i></NuxtLink>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane opacity-0 mentions-section opacity-100 block active"
                                                        ...
                                                        <div class="tab-pane opacity-0" id="pills-favorites" role="tabpanel"
                                                        ...
                                                        <div class="tab-pane opacity-0" id="pills-friends" role="tabpanel"
                                                        ...
                                                        <div class="tab-pane opacity-0" id="pills-groups" role="tabpanel"
                                        ...
                                        <!-- Aside Part -->
                                        <div class="xl:w-1/3 pr-4 pl-4">
                                            <aside class="mt-5 xl:mt-0">
                                                    ...
                                                    <div class="widget-inner">
                                                        ...
                                                        <div class="widget-content">
                                                            ...
                                                            <form action="/" class="banner-form">
                                                                <div class="gender">
                                                                    <div class="custom-select right w-full">
                                                                        <select class="">
                                                                ...
                                                                <div class="age">
                                                                    <div
                                                                        class="right flex justify-between w-full">
                                                                        <div class="custom-select">
                                                                            <select>
                                                ...
                                                <div class="widget like-member">
                                                    <div class="widget-inner">
                                                        ...
                                                        <div class="widget-content">
                                                            <div class="flex flex-wrap  row-cols-3 row-cols-sm-auto g-3">
                                                            ...
                                                            <div class="group-item lab-item">
                                                                <div
                                                                    ...
                                                                    <div class="lab-content w-full">
                                                                        ...
                                                                        <div class="test"> <NuxtLink to="/profile"
                                                                                class="lab-btn"><i
                            ...
                            <!-- Profile tab -->
                            <div class="tab-pane opacity-0" id="profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div>
                                    <div class="flex flex-wrap ">
                                        <div class="xl:w-2/3 pr-4 pl-4">
                                            <article>
                            ...
                            <!-- Frinds Tab -->
                            <div class="tab-pane opacity-0" id="friends" role="tabpanel" aria-labelledby="nav-friends-tab">
                                <div>
                                    <div class="flex flex-wrap ">
                                        <div class="xl:w-2/3 pr-4 pl-4">
                                            <article>
                                                <div class="flex flex-wrap  gy-4 gx-3 justify-center">
                                                    <div class=" lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>jenifer Guido</NuxtLink> </h6>
                                                                    <p>Active 1 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Andrea Guido</NuxtLink> </h6>
                                                                    <p>Active 2 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Anna hawk</NuxtLink> </h6>
                                                                    <p>Active 5 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Andreas Adam</NuxtLink> </h6>
                                                                    <p>Active 4 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Alaina T</NuxtLink> </h6>
                                                                    <p>Active 1 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Aron Smith</NuxtLink> </h6>
                                                                    <p>Active 3 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Helen Gomz</NuxtLink> </h6>
                                                                    <p>Active 3 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Andrez jr</NuxtLink> </h6>
                                                                    <p>Active 5 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Ladiga Guido</NuxtLink> </h6>
                                                                    <p>Active 5 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Jene Aiko</NuxtLink> </h6>
                                                                    <p>Active 4 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Jhon Cena</NuxtLink> </h6>
                                                                    <p>Active 2 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Irfan Patel </NuxtLink> </h6>
                                                                    <p>Active 5 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Hames Radregez</NuxtLink> </h6>
                                                                    <p>Active 1 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Johan ben</NuxtLink> </h6>
                                                                    <p>Active 2 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Johannes</NuxtLink> </h6>
                                                                    <p>Active 6 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Helena Mind</NuxtLink> </h6>
                                                                    <p>Active 4 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Virat Alba</NuxtLink> </h6>
                                                                    <p>Active 3 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Afrin Nawr</NuxtLink> </h6>
                                                                    <p>Active 5 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="lg:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 w-1/2">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                ...
                                                                <div class="lab-content">
                                                                    <h6><NuxtLink to=' '>Jason Roy</NuxtLink> </h6>
                                                                    <p>Active 2 Day</p>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <!-- Group Tab -->
                            <div class="tab-pane opacity-0" id="groups" role="tabpanel" aria-labelledby="nav-groups-tab">
                                <div>
                                    <div class="flex flex-wrap ">
                                        <div class="xl:w-2/3 pr-4 pl-4">
                                            <article>
                                                <div class="flex flex-wrap  gy-3">
                                                    <div class="w-full">
                                                        <div class="group-item lab-item style-1">
                                                            <div
                                                                class="lab-inner flex flex-wrap items-center p-6">
                                                                <div class="lab-thumb md:me-6 mb-4 md:mb-0">
                            ...
                            <!-- Photos Tab -->
                            <div class="tab-pane opacity-0" id="photos" role="tabpanel" aria-labelledby="nav-photos-tab">
                                <div class="photo-title text-center border-radius-2 bg-white p-1 mb-4">
                                    <h3 class="mb-0">All Uploaded Pictures</h3>
                                </div>
                                <div
                                    class="flex flex-wrap  g-3 g-lg-4 justify-center row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 row-cols-xl-6">
                                    <div class="relative flex-grow max-w-full flex-1 px-4">
                                ...
                                <div class="load-btn">
                                    <NuxtLink to="" class="lab-btn">Load More<i class="icofont-spinner"></i></NuxtLink>
                                </div>
                            </div>
                            <!-- Media Tab -->
                            <div class="tab-pane opacity-0" id="media" role="tabpanel" aria-labelledby="nav-media-tab">
                                <div>
                                    <div class="flex flex-wrap ">
                                        <div class="xl:w-2/3 pr-4 pl-4">
                                            <article>
                                                <div class="media-wrapper">
                                                    <ul class="flex flex-wrap list-none pl-0 mb-0 border border-t-0 border-r-0 border-l-0 border-b-1 border-gray-200" id="myTab" role="tablist">
                                                        <li class="" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline active" id="all-media-tab"
                                                        ...
                                                        <li class="" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="album-tab" data-bs-toggle="tab"
                                                        ...
                                                        <li class="" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="photos-media-tab"
                                                        ...
                                                        <li class="" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="video-tab" data-bs-toggle="tab"
                                                        ...
                                                        <li class="" role="presentation">
                                                            <button class="inline-block py-2 px-4 no-underline" id="music-tab" data-bs-toggle="tab"
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <!-- All Media Tab -->
                                                        <div class="tab-pane opacity-0 opacity-100 block active" id="all-media"
                                                            ...
                                                            <div class="media-content">
                                                                ...
                                                                <div
                                                                    class="flex flex-wrap  row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 row-cols-xl-4 g-3">
                                                                    <div class="relative flex-grow max-w-full flex-1 px-4">
                                                                ...
                                                                <div class="load-btn">
                                                                    <NuxtLink to="" class="lab-btn">Load More<i
                                                                            class="icofont-spinner"></i></NuxtLink>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <!-- Albums -->
                                                        <div class="tab-pane opacity-0" id="album" role="tabpanel"
                                                            ...
                                                            <div class="media-content">
                                                                ...
                                                                <div class="flex flex-wrap  g-4">
                                                                    <div class="lg:w-1/3 pr-4 pl-4 sm:w-1/2 pr-4 pl-4">
                                                        ...
                                                        <!-- Photos -->
                                                        <div class="tab-pane opacity-0" id="photos-media" role="tabpanel"
                                                        ...
                                                        <!-- Videos -->
                                                        <div class="tab-pane opacity-0" id="video" role="tabpanel"
                                                        ...
                                                        <!-- Music -->
                                                        <div class="tab-pane opacity-0" id="music" role="tabpanel"
