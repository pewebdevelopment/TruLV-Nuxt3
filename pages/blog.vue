<template>
  <section>
            ...
            <ol class="page-title">
              <li>
                <NuxtLink to="/" class="font-bold"
                  >Home - <span class="font-normal">Blog</span></NuxtLink
                >
              </li>
            </ol>
          </div>
    ...
    <section class="blog-section padding-tb bg-ash">
      <div class="container mx-auto sm:px-4">
        <div class="main-blog">
          <div class="flex flex-wrap">
            <div class="lg:w-2/3 pr-4 pl-4 w-full">
              <div class="blog-wrapper">
                <div class="post-item">
                  <div class="post-item-inner">
                    <div class="post-thumb">
                      <NuxtLink to="/blog-single"
                        ><img src="../assets/images/blog/01.jpg" alt="blog"
                      /></NuxtLink>
                    </div>
                    <div class="post-content">
                      <span class="meta"
                        >By <NuxtLink to="">Admin</NuxtLink> March 24,
                        2021</span
                      >
                      <h3>
                        <NuxtLink to="/blog-single"
                          >Uompe Qrear High Ecent Nche Without Some Prin Uomp
                          Without Some Qreari</NuxtLink
                        >
                      </h3>
                      <p>
                        Rapidious qntegrate distrbuted supply chains throuih
                        marke position bestn practces chain marke positonn
                        bestin practcer ieractvel fashon and sound qources forin
                        iteractve fashion bestin practce ieractve and sound
                        qources for.
                      </p>
                    </div>
                    <div class="blog-footer">
                      <NuxtLink to="/blog-single" class="viewall"
                        >Read More <i class="icofont-double-right"></i
                      ></NuxtLink>
                      <div class="right">
                        <NuxtLink to="" class="blog-heart"
                          ><i class="icofont-heart-alt"></i> 12
                          <span class="hidden sm:inline-block">Like</span>
                        </NuxtLink>
                        <NuxtLink to="" class="blog-comment"
                          ><i class="icofont-comment"></i> 24
                ...
                <div class="post-item post-slider">
                  <div class="post-item-inner">
                    ...
                    <div class="post-content">
                      <span class="meta"
                        >By <NuxtLink to="/blog-single">Admin</NuxtLink> March
                        24, 2021</span
                      >
                      <h3>
                        <NuxtLink to="/blog-single"
                ...
                <div class="post-item video-post">
                  <div class="post-item-inner">
                    <div class="post-thumb">
                      <div class="">
                        <iframe
                          src="https://www.youtube.com/embed/ViOZGtS8FG4"
                          allowfullscreen
                        ></iframe>
                      </div>
                    </div>
              ...
              <div class="paginations">
                <ul class="lab-ul flex flex-wrap justify-center mb-1">
                  <li>
                    <NuxtLink to=""
            ...
            <div class="lg:w-1/3 pr-4 pl-4 w-full">
              <aside class="mt-5 lg:mt-0">
                <div class="widget search-widget">
                  <div class="widget-inner">
                    ...
                    <div class="widget-content">
                      <p>
                        Serious Dating With TuruLav Your Perfect Match is Just a
                        Click Away.
                      </p>
                      <form action="/" class="banner-form">
                        ...
                        <div class="age">
                          <div class="right flex justify-between w-full">
                ...
                <div class="widget like-member">
                  <div class="widget-inner">
                    ...
                    <div class="widget-content">
                      <div
                        class="flex flex-wrap row-cols-3 row-cols-sm-auto g-3"
                      >
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/01.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/02.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/03.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/04.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/05.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/06.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/07.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/08.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                        ...
                        <div class="relative flex-grow max-w-full flex-1 px-4">
                          <div class="image-thumb">
                            <NuxtLink to="">
                              <img
                                src="../assets/images/widget/09.jpg"
                                alt="img"
                              />
                            </NuxtLink>
                          </div>
                  ...
                  <div class="widget-inner">
                    ...
                    <div class="widget-content">
                      <div class="group-item lab-item">
                        <div class="lab-inner flex flex-wrap items-center">
                          <div class="lab-content w-full">
                            <h6>Active Group A1</h6>
                            <p>
                              Colabors atively fabcate best breed and apcations
                              through visionary
                            </p>
                            ...
                            <div class="test">
                              <NuxtLink to="/profile" class="lab-btn"
                                ><i class="icofont-users-alt-5"></i> View
                                Group</NuxtLink
                              >
                            </div>
                          </div>
